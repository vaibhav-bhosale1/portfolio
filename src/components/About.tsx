...
const About = () => {
  return (
    <div className='max-w-[1100px] mx-auto mt-10 b-0' id='about'>
            ...
            <div className='absolute inset-0 bg-gradient-to-r from-orange-500 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
                <div className='flex flex-row p-6'>
                    ...
                    <div className='grid md:grid-cols-2 mt-3'>
                        <h2 className='text-xl font-bold text-white hover:text-orange-500 mb-4  cursor-pointer'>
                            Github<a href="https://github.com/vaibhavbhosale1" className='text-orange-300 cursor-pointer'>
                                           <FaGithub size={24}/> 
                                         </a>
                        </h2>
                        <h2 className='text-xl font-bold text-white'>
                            Leetcode<a href="#" className='text-orange-300'>
                                           <SiLeetcode size={24}/> 
                                         </a>
                        </h2>
                        <h2 className='text-xl font-bold text-white '>
                            Linkedin  <a href="#" className='text-orange-300'>
                                           <FaLinkedin size={24}/> 
                                         </a>
                        </h2>
                        <h2 className='text-xl font-bold text-white '>
                            GeeksforGeeks  <a href="#" className='text-orange-300'>
            ...
            <div className='absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy'></div>
                <div className='flex flex-row p-6'>
                    ...
                    <div className='flex flex-col mt-4'>
                        ...
                        <p className='text-lg  text-white mt-1'>I am a BTech student in Electronics and Telecommunication at VIIT Pune, with expertise in web development and software engineering. I have worked on impactful projects during internships at Bluestock Fintech and Suvidha Foundation, specializing in React, Node.js, and Next.js. I am skilled at creating responsive web interfaces and seamless backend integrations, and I actively contribute to technical communities as a proactive leader and team player.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className='flex flex-col mt-4'>
                     <section id="experience" className=" py-7">
                        <div className="container mx-auto px-5">
                            <h2 className="text-3xl font-bold text-cente mb-3 text-orange-500 underline">Internship Experience</h2>
                            <div className="">
